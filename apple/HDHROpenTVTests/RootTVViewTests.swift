...
final class RootTVViewTests: XCTestCase {
    ...
    private func makeEnvironmentObjects() -> (AuthManager, AuthViewModel, PlayerViewModel) {
        ...
        return (authManager, authViewModel, playerViewModel)
    }

    func testShowsProfilePickerWhenUnauthenticated() throws {
        let (authManager, authViewModel, playerViewModel) = makeEnvironmentObjects()
